...
| C++                                                                   | Python                                                                |
| --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| ![Llama 3B C++](../.gitbook/assets/fig_norm_llama_3b_cpp.png)         | ![Llama 3B Python](../.gitbook/assets/fig_norm_llama_3b_python.png)   |
| **Math**                                                              | **Medical**                                                           |
| ![Llama 3B Math](../.gitbook/assets/fig_norm_llama_3b_math.png)       | ![Llama 3B Medical](../.gitbook/assets/fig_norm_llama_3b_medical.png) |
| **Science**                                                           | **Finance**                                                           |
| ![Llama 3B Science](../.gitbook/assets/fig_norm_llama_3b_science.png) | ![Llama 3B Finance](../.gitbook/assets/fig_norm_llama_3b_finance.png) |

#### Llama 3.2 1B - Layer-wise Weight Changes

| C++                                                                   | Python                                                                |
| --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| ![Llama 1B C++](../.gitbook/assets/fig_norm_llama_1b_cpp.png)         | ![Llama 1B Python](../.gitbook/assets/fig_norm_llama_1b_python.png)   |
| **Math**                                                              | **Medical**                                                           |
| ![Llama 1B Math](../.gitbook/assets/fig_norm_llama_1b_math.png)       | ![Llama 1B Medical](../.gitbook/assets/fig_norm_llama_1b_medical.png) |
| **Science**                                                           | **Finance**                                                           |
| ![Llama 1B Science](../.gitbook/assets/fig_norm_llama_1b_science.png) | ![Llama 1B Finance](../.gitbook/assets/fig_norm_llama_1b_finance.png) |

#### Gemma 3 4B - Layer-wise Weight Changes

| C++                                                                   | Python                                                                |
| --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| ![Gemma 4B C++](../.gitbook/assets/fig_norm_gemma_4b_cpp.png)         | ![Gemma 4B Python](../.gitbook/assets/fig_norm_gemma_4b_python.png)   |
| **Math**                                                              | **Medical**                                                           |
| ![Gemma 4B Math](../.gitbook/assets/fig_norm_gemma_4b_math.png)       | ![Gemma 4B Medical](../.gitbook/assets/fig_norm_gemma_4b_medical.png) |
| **Science**                                                           | **Finance**                                                           |
| ![Gemma 4B Science](../.gitbook/assets/fig_norm_gemma_4b_science.png) | ![Gemma 4B Finance](../.gitbook/assets/fig_norm_gemma_4b_finance.png) |

#### Gemma 3 1B - Layer-wise Weight Changes

| C++                                                                   | Python                                                                |
| --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| ![Gemma 1B C++](../.gitbook/assets/fig_norm_gemma_1b_cpp.png)         | ![Gemma 1B Python](../.gitbook/assets/fig_norm_gemma_1b_python.png)   |
| **Math**                                                              | **Medical**                                                           |
| ![Gemma 1B Math](../.gitbook/assets/fig_norm_gemma_1b_math.png)       | ![Gemma 1B Medical](../.gitbook/assets/fig_norm_gemma_1b_medical.png) |
| **Science**                                                           | **Finance**                                                           |
| ![Gemma 1B Science](../.gitbook/assets/fig_norm_gemma_1b_science.png) | ![Gemma 1B Finance](../.gitbook/assets/fig_norm_gemma_1b_finance.png) |
